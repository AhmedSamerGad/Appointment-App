...
void main() async {
  ...
  isLoggedInUser = await validateStoredToken();
   print('App start auth check. Token exists: , ${isLoggedInUser ? 'Yes' : 'No}'}');
...
class MyApp extends StatelessWidget {
 ...
 const  MyApp({super.key, required this.appRouters, required this.isLoggedInUser});
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      ...
      child: MaterialApp(
        ...
        initialRoute: isLoggedInUser ? StringRoutes.calender : StringRoutes.login,
